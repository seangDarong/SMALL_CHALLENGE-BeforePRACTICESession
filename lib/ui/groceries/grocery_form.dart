...
import 'package:mon15/data/mock_grocery_repository.dart';
...
void onReset() {
  ...
  void onAdd() {
    ...
    String id = (dummyGroceryItems.length+1).toString();
    
    Grocery newGrocery = Grocery(id: id, name: name, quantity: quantity, category: _selectedCategory);
                  ...
                  child: DropdownButtonFormField<GroceryCategory>(
                    ...
                    items: GroceryCategory.values.map((category){
                      return DropdownMenuItem<GroceryCategory>(
                        value: category,
                        child: Row(children: [
                          Container(width: 15,height: 15,color: category.color),SizedBox(width: 5,),Text(category.name, style: TextStyle(color: Colors.white),)
